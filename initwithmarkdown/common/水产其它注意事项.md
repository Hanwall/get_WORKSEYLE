...
![](http://ring4uys0.hd-bkt.clouddn.com/common/示例水产报损.jpeg ':size=50%')

> 旧水产海鲜池

![](http://ring4uys0.hd-bkt.clouddn.com/common/示例旧水产海鲜池.jpeg ':size=50%')

> 新的水产池

![](http://ring4uys0.hd-bkt.clouddn.com/common/示例新的水产池.jpeg ':size=50%')

> 旧的盐度计

![](http://ring4uys0.hd-bkt.clouddn.com/common/示例旧的盐度计.jpeg ':size=50%')

> 新的盐度计

![](http://ring4uys0.hd-bkt.clouddn.com/common/示例新的盐度计.jpeg ':size=50%')

> 温度计

![](http://ring4uys0.hd-bkt.clouddn.com/common/示例温度计.jpeg ':size=50%')

> 新的接货流程

![](http://ring4uys0.hd-bkt.clouddn.com/common/示例新的接货流程.jpeg ':size=50%')

> 水产收货单带标记

![](http://ring4uys0.hd-bkt.clouddn.com/common/示例水产收货单1.jpeg ':size=50%')

> 水产收货单带标记

![](http://ring4uys0.hd-bkt.clouddn.com/common/示例水产收货单最新形式1.jpeg ':size=50%')

> 水产收货单带标记和去损

![](http://ring4uys0.hd-bkt.clouddn.com/common/示例水产收货单最新形式2.jpeg ':size=50%')

> 水产运输温度盐度表

![](http://ring4uys0.hd-bkt.clouddn.com/common/示例水产运输温度盐度表.jpeg ':size=50%')

> 水产养殖温度盐度表

![](http://ring4uys0.hd-bkt.clouddn.com/common/示例水产养殖温度盐度表.jpeg ':size=50%')
...
* <p><a href="https://hanwall.github.io/WORKFLOWS4COMPANY/resources/files/official/夜班水产监控表-旧表.docx">夜班水产监控表-旧表.docx</a></p>
